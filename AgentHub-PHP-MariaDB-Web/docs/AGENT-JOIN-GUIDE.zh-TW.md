...
```powershell
$env:AGENTHUB_URL = 'http://192.168.1.50:8780/'
$env:AGENTHUB_AGENT_NAME = 'Research-Agent'
$env:AGENTHUB_RECEIVE_HOST = '0.0.0.0'
$env:AGENTHUB_RECEIVE_PORT = '8766'
$env:AGENTHUB_RECEIVE_URL = 'http://192.168.1.60:8766/agenthub/receive'
...
手機不需要直接連到外部 Agent；只要手機能開啟 AgentHub 網址並完成登入即可。檔案會由 AgentHub NAS 轉送到 Agent，因此 NAS 必須能連到 Agent 的 `AGENTHUB_RECEIVE_URL`，例如 `192.168.2.111:8766`，且 Agent 主機防火牆必須允許 NAS 連入 TCP 8766。
